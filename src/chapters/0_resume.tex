...
périmètre des contributions actuelles. Le compilateur prototype n'implémente pas encore le système
de types réactifs, ce qui signifie que les garanties contre le sur-échantillonnage ne sont pas
encore appliquées en pratique. Les preuves sémantiques ont été réalisées manuellement et n'ont pas
...
\paragraph{Évolution du Langage et du Compilateur} La priorité est de finaliser l'implémentation du
système de types réactifs dans le compilateur pour garantir statiquement la résilience au
sur-échantillonnage. À plus long terme, le compilateur pourrait être rendu agnostique au
