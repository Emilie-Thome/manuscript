...
correct usage is governed by a type system, detailed in \Cref{sec:grust:typing}. In the semantics,
they are used to distinguish the behavior of signals from that of events.
%
