...
It combines the declaration of services, entities that computes dataflows, and their interaction
...
In \GRFRP, dataflows are categorized as \emph{signals} for continuous values and \emph{events} for
